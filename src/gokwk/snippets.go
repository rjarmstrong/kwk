...
func (rs *SnippetsGrpc) AlphaSearch(term string) (*models.SearchTermResponse, error) {
...
func (rs *SnippetsGrpc) Delete(username string, pouch string, names []*types.SnipName) error {
...
func (rs *SnippetsGrpc) GetRoot(username string, all bool) (*models.ListView, error) {

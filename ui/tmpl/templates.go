...
func init() {
	...
	add("snippet:newprivate", MARGIN+ "👍  {{.String | blue }} created "+style.Lock+"\n\n", template.FuncMap{"blue": blue})
	...
	add("snippet:tag", "{{.String | blue }} tagged.", template.FuncMap{"blue": blue})
	add("snippet:untag", "{{.String | blue }} untagged.", template.FuncMap{"blue": blue})
	add("snippet:renamed", "{{.originalName | blue }} renamed to {{.newName | blue }}", template.FuncMap{"blue": blue})
	add("snippet:patched", "{{.String | blue }} patched.", template.FuncMap{"blue": blue})
